...
priors["tilt_1"] = bilby.gw.prior.DeltaFunction(
    peak=0.0, name="tilt_1", latex_label="$\\theta_1$", unit=None
)
priors["tilt_2"] = bilby.gw.prior.DeltaFunction(
    peak=0.0, name="tilt_2", latex_label="$\\theta_2$", unit=None
)
priors["phi_12"] = bilby.gw.prior.DeltaFunction(
    peak=0.0, name="phi_12", latex_label="$\\phi_{12}$", unit=None
)
priors["phi_jl"] = bilby.gw.prior.DeltaFunction(
    peak=0.0, name="phi_jl", latex_label="$\\phi_{JL}$", unit=None
)
...
ripple_params = np.array(
    [Mc, eta, a_1, a_2, distance, 0, phi_0, theta_jn, psi, dec, ra]
)
m1, m2 = Mc_eta_to_ms([Mc, eta])
ripple_h = gen_IMRPhenomD_polar(f, ripple_params)
bilby_h = waveform_generator.frequency_domain_strain(parameters)
lal_bilby_h = bilby.gw.source.lal_binary_black_hole(
    f, m1, m2, distance, a_1, 0, 0, a_2, 0, 0, theta_jn, phi_0
)
