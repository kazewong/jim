...
H1_lat = 46 + 27.0 / 60 + 18.528 / 3600
H1_long = -(119 + 24.0 / 60 + 27.5657 / 3600)
...
strain = waveform[
    "plus"
]  # get_detector_response(waveform,injection_parameters,H1).T[0]
...
print(
    "True likelihood"
    + str(jax_likelihood(injection_parameters, strain, waveform_frequency, psd_interp))
)
print(
    "Guess likelihood"
    + str(jax_likelihood(guess_parameters, strain, waveform_frequency, psd_interp))
)
...
def step(step, opt_state):
    ...
    value, grads = value_and_grad(jax_likelihood, argnums=(0))(
        params, strain, waveform_frequency, psd_interp
    )
