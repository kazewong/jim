...
def generate_initial_samples(
    ...
    This function repeatedly samples from the prior and applies transforms until all samples
    contain finite values. This is necessary because some parameter combinations may result
    in invalid (NaN/inf) values after transformation.
