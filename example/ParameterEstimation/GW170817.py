...
# H1_data = (H1_data * tukey(len(H1_data), alpha=0.2)).fft()*duration/2
# H1_frequency = H1_data.frequencies.value
...
# H1_data = H1_data[H1_frequency>minimum_frequency].value
...
# L1_data = (L1_data * tukey(len(L1_data), alpha=0.2)).fft()*duration/2
# L1_frequency = L1_data.frequencies.value
...
# L1_data = L1_data[L1_frequency>minimum_frequency].value
...
# V1_data = (V1_data * tukey(len(V1_data), alpha=0.2)).fft()*duration/2
# V1_frequency = V1_data.frequencies.value
...
# V1_data = V1_data[V1_frequency>minimum_frequency].value
...
H1_data = data['data_dict'].tolist()['H1'][H1_frequency>minimum_frequency]
H1_psd = data['psd_dict'].tolist()['H1'][H1_frequency>minimum_frequency]
H1_frequency = H1_frequency[H1_frequency>minimum_frequency]

L1_frequency = data['frequency']
L1_data = data['data_dict'].tolist()['L1'][L1_frequency>minimum_frequency]
L1_psd = data['psd_dict'].tolist()['L1'][L1_frequency>minimum_frequency]
L1_frequency = L1_frequency[L1_frequency>minimum_frequency]

V1_frequency = data['frequency']
V1_data = data['data_dict'].tolist()['V1'][V1_frequency>minimum_frequency]
V1_psd = data['psd_dict'].tolist()['V1'][V1_frequency>minimum_frequency]
V1_frequency = V1_frequency[V1_frequency>minimum_frequency]
...
ref_param = jnp.array([ 1.19783850e+00,  2.18306739e-01,  9.39092173e-02,
        5.52051679e-02,  6.43884200e+01,  2.74221018e-02,
        3.52088503e+00,  5.68719335e-01,  2.60072399e+00,
        3.64786145e+00, -7.20526813e-01])
...
prior_range = jnp.array([[1.18,1.20],[0.20,0.25],[0,0.1],[0,0.1],[0,200],[-0.1,0.1],[0,2*np.pi],[0,np.pi],[0,np.pi],[0,2*np.pi],[-np.pi/2,np.pi/2]])
